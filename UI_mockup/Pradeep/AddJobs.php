        ...
        <div class="form-row justify-content-center align-items-center">
            <div class="col-5">
                ...
                <div class="custom-control custom-radio">
                    ...
                    <label class="custom-control-label" for="defaultChecked">Individual</label>
                </div>
                <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input" id="defaultUnchecked" name="AdType">
                    <label class="custom-control-label" for="defaultUnchecked">Professional Employer</label>
                </div>
                <br>
                <label for="textInput">Company</label>
                <input type="text" id="textInput" class="form-control mb-4" placeholder="optional">
                ...
                <select class="browser-default custom-select mb-4" id="select">
                    ...
                    <option value="5">Please Contact</option>
                </select>
